...
const PROFILE_PROMPT = `Você está sintetizando um perfil cumulativo do usuário Diogo a partir de memórias e conversas recentes do Nook.

Receberá:
1. Memórias destiladas (já são síntese de conversas anteriores)
2. Trechos de conversas recentes

Sua tarefa: produzir um perfil compacto que ajude o Nook a colaborar melhor em futuras conversas. Foque em sinais persistentes, não eventos pontuais.
...
## Nota
- 1-2 frases de meta-observação útil pro Nook (ex: "prefere PT-BR mas escreve código em inglês")
